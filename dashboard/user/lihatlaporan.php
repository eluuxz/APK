                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between">
                            <h1 class="h3 mb-0 text-gray-800">Laporan Anda</h1>
                        </div>
                        <hr>
                                            ...
                                            <table class="table" id="table_id">
                                                ...
                                                <tbody>
                                                    <?php
                                                        ...
                                                        $query_mysql = $conn->query("SELECT * FROM laporan where id_user = $id_user ORDER BY id_laporan DESC");
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php 
                                                                    if ($data['status'] === "tanggap"){
                                                                        echo '
                                                                        <div class="w-100 p-1 bg-success text-white text-center rounded">
                                                                            Telah Ditanggapi
                                                                        </div>
                                                                        ';
                                                                    } else if ($data['status'] === "proses"){
                                                                        echo '
                                                                        <div class="w-100 p-1 bg-warning text-dark text-center rounded">
                                                                            Proses Verifikasi
                                                                        </div>
                                                                        ';
                                                                    } else if ($data['status'] === "selesai"){
                                                                        echo '
                                                                        <div class="w-100 p-1 bg-primary text-white text-center rounded">
                                                                            Telah Diverifikasi
                                                                        </div>
                                                                        ';
                                                                    }
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="#" class="btn btn-primary btn-sm <?php if ($data['status'] === "tanggap"){ echo 'disabled'; } ?>" data-toggle="modal" data-target="#editlaporan<?php echo $data['id_laporan']; ?>"> <i class="fas fa-edit mr-2"></i>EDIT </a>
                                                                <!-- Modal Edit Lpaoran -->
                                                                        ...
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <form action="" method="POST" enctype="multipart/form-data">
                                                                                ...
                                                                                <div class="modal-footer">
                                                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                                    <button type="submit" class="btn btn-primary" name="editlaporan">Edit Laporan</button>
                                                                                </div>
                                                                            </form>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <a href="#" class="btn btn-danger btn-sm <?php if ($data['status'] === "tanggap"){ echo 'disabled'; } ?>" data-toggle="modal" data-target="#hapuslaporan<?php echo $data['id_laporan']; ?>"> <i class="fas fa-trash-alt mr-2"></i>HAPUS </a>
                                                                <!-- Modal Hapus Lpaoran -->
                                                                <div class="modal fade" id="hapuslaporan<?php echo $data['id_laporan']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                    <div class="modal-dialog">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h5 class="modal-title" id="exampleModalLabel">Konfirmasi Hapus Laporan</h5>
                                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                    <span aria-hidden="true">&times;</span>
                                                                                </button>
                                                                            </div>
                                                                            <div class="modal-body">
                                                                                <p>Apakah Anda Yakin Ingin Menghapus Laporan Anda ? </p>
                                                                            </div>
                                                                            <div class="modal-footer">
                                                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                                <a href="../../app/function.php?hapuslaporan&id_laporan=<?php echo $data['id_laporan']; ?>" class="btn btn-danger">Hapus</a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
