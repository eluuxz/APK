            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid text-center">
                        <div class="row py-5">
                            <div class="col-7 py-5 mt-3">
                                <div class="desc ml-5">
                                    <h2 class="text-gray-800">Selamat datang di website pengaduan masyarakat</h2>
                                    ...
                                    <a href="laporan.php" class="btn btn-primary shadow">Buat Laporan</a>
                                    <a href="lihatlaporan.php" class="btn btn-outline-primary ml-2">Lihat Laporan</a>
                                </div>
                            </div>
                            <div class="col-5">
                                <div class="img-fluid">
                                    <img src="../../assets/img-dashboard-user.svg" width="450" alt="">
                                </div>
                            </div>
                        </div>
